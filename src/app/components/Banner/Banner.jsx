...
const Banner = () => {
  return (
    <div className="relative w-full max-h-[600px] text-white">
      ...
      <div className='container px-[15px] sm:px-[25px] md:px-[40px] lg:px-[55px] xl:px-[70px] py-[15px] lg:py-[30px] z-30 h-[600px] w-full flex flex-col items-center justify-center gap-[20px]'>
